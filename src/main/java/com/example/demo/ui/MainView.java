...
import com.example.demo.ui.components.AvatarField;
...
public class MainView extends VerticalLayout {
    ...
    public MainView(@Autowired UserDetailsService service) {
        ...
        FormLayout formLayout = new FormLayout(title, firstnameField, lastnameField, queryButton, handleField, avatarField, passwordField1, passwordField2,
